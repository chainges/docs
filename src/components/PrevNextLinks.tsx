  ...
  return (
    <div {...props}>
      <dt className="font-display text-sm font-medium text-slate-900 dark:text-white">
        {dir === 'next' ? 'Neste' : 'Forrige'}
      </dt>
      <dd className="mt-1">
        <Link
          href={href}
          className={clsx(
            'flex items-center gap-x-1 rounded-lg p-3 text-base font-semibold tracking-wide text-slate-500 ring-1 ring-slate-100 transition-colors hover:bg-gray-100 hover:text-slate-600 dark:text-slate-400 dark:ring-slate-700 dark:hover:bg-slate-800 dark:hover:text-slate-300',
